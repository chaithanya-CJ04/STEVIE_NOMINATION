          ...
          <header className="mb-10 flex items-center justify-between gap-4">
            ...
            {!isChecking && (
              <button
                ...
                className="hidden rounded-full border border-zinc-700/80 px-4 py-2 text-xs font-medium uppercase tracking-[0.16em] text-zinc-200 transition hover:border-amber-400 hover:text-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-400/50 md:inline-flex"
                aria-label={isLoggedIn ? "Go to chat" : "Go to login"}
              >
          ...
          <section className="grid gap-10 md:grid-cols-[3fr,2fr] md:items-center">
            ...
            <div className="relative flex h-full items-center justify-center">
              <div className="relative w-full max-w-md rounded-3xl border border-amber-400/40 bg-zinc-950/80 p-5 shadow-[0_0_40px_rgba(251,191,36,0.4)]">
                ...
                <div className="space-y-3 text-xs" role="presentation" aria-label="Chat preview">
