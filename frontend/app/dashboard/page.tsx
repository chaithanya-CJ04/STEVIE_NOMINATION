...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-8 md:flex-row">
      ...
      <section className="flex-1 rounded-[32px] border border-zinc-800/70 bg-black/80 px-10 py-12 text-zinc-100 shadow-[0_0_60px_rgba(0,0,0,0.9)]">
      ...
      <aside className="mt-2 w-full max-w-md rounded-3xl border border-amber-400/50 bg-zinc-950/90 p-5 text-zinc-100 shadow-[0_0_55px_rgba(251,191,36,0.55)] md:mt-0 md:w-80">
        ...
        <div className="mb-4 max-h-72 space-y-2 overflow-y-auto pr-1 text-[12px]">
          {messages.map((m) => (
            <div
              key={m.id}
              className={
