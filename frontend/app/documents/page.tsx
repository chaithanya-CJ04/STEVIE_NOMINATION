                  ...
                  <div className="w-full max-w-3xl">
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer">
                      <div
                        ...
                        onDrop={handleDrop}
                        className={`flex flex-col items-center justify-center gap-6 rounded-3xl border-2 border-dashed px-12 py-16 transition-all focus-within:outline-none focus-within:ring-2 focus-within:ring-amber-400/50 ${isDragging
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {categories.map(cat => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all focus:outline-none focus:ring-2 focus:ring-amber-400/50 ${selectedCategory === cat.id
